...
class _LoginScreenState extends BaseRouteState {
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        Text(
                            isLoginWithEmail
                                ? '${AppLocalizations.of(context)!.tle_login_with}'
                        ...
                        Padding(
                          ...
                          child: Text(
                              isLoginWithEmail
                                  ? '${AppLocalizations.of(context)!.txt_email_password}'
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                  '  ${AppLocalizations.of(context)!.txt_login_signup_using}  ',
                                  style: Theme.of(context)
                                      .primaryTextTheme
                                      .bodyText1),
                              Expanded(
  ...
  _selectPhoneNumber() {
    try {
      ...
      print("Exception - loginScreen.dart - _showCupertinoModalSheet():" +
          e.toString());
    }
  }
